...
//从Data文件夹中的imageDatas.json中获取图片相关的数据
var imageDatas = require('../data/imageDatas.json');
//将图片名信息转成图片的URL路径信息，为json文件中的每一个图片对象添加路径信息imageURL
...
var GalleryByReactApp = React.createClass({
    ...
    */
    ...
    render: function() {
        //定义两个数组，分别用来存放图片和控制按钮
        var controllerUnits = [],
            imageFigures = [];
        //遍历数组，并把每一个图片组件添加进数组中
        imageDatas.forEach(function(value, index) {
            ...
            imageFigures.push(<ImageFigure data={value} ref={'imgFigure' + index} inverse={this.inverse(index)} center={this.center(index)} arrange={this.state.imgsArrangeArr[index]}/>);
